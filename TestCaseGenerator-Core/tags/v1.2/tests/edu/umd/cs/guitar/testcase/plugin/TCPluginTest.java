...
public class TCPluginTest extends TestCase {
	...
	public void testParseInitialEvents1() {
		...
		// using reflection to call the private methods
		accessParseInitialEvents(m_TCPluginStub);
	...
	public void testParseInitialEvents2() {
		// using reflection to call the private methods
		accessParseInitialEvents(m_TCPluginVoidStub);
	...
	public void testParseInitialEvents3() {
		...
		// define the expected result
		String nameList = "e0e1e2e3";

		// using reflection to call the private methods
		accessParseInitialEvents(m_TCPlugin5EventsStub);
	...
	/**
	 * This function accesses the private method ParseFollowRelations() in
	 * TCPlugin class. <br/>
	 * <br/>
	 * Since ParseFollowRelations() is a private method, the reflection is used
	 * to test it.
	 */
	private void accessParseFollowRelations(TCPlugin object) {
		// using reflection to call the private methods
		try {
			Method m = TCPlugin.class.getDeclaredMethod("parseFollowRelations");
			m.setAccessible(true);
			m.invoke(object, null);
		} catch (NoSuchMethodException e) {
			System.out.println("No such method is found");
	...
	public void testParseFollowRelations1() {
		...
		// using reflection to call the private methods
		accessParseInitialEvents(m_TCPluginStub);
		accessParseFollowRelations(m_TCPluginStub);
	...
	public void testParseFollowRelations2() {
		...
		// using reflection to call the private methods
		accessParseInitialEvents(m_TCPluginVoidStub);
		accessParseFollowRelations(m_TCPluginVoidStub);
	...
	public void testParseFollowRelations3() {
		...
		// using reflection to call the private methods
		accessParseInitialEvents(m_TCPlugin5EventsStub);
		accessParseFollowRelations(m_TCPlugin5EventsStub);
	...
	public void testWriteToFile() {
		...
		path.add(event);
		path.add(event);
		String tc = ".//tests//outputs//test.txt";
