   ...
   */
    ...
    public void testGenerate(){
		...
		try{																							//2 and 3
			...
			assertEquals(AttributesType.attributesTypeCounter, 70);
			assertEquals(ComponentType.componentTypeCounter, 62);
			...
			assertEquals( PropertyType.propertyTypeCounter, 210);
			assertEquals(RowType.rowTypeCounter, 4);
			assertEquals(ComponentTypeWrapper.componentTypeWrapperCounter_ComponentTypeWrapper, 27);
			...
			assertEquals(ComponentTypeWrapper.componentTypeWrapperCounter_getFirstValueByName, 10);
			...
			assertEquals(EventWrapper.eventWrapperCounter_getComponent, 10);
