...
public abstract class IphSwipeEventThread extends GThreadEvent{

	public String eventname = "SWIPE";
	...
	public void performImpl(GComponent gComponent,Hashtable<String, List<String>> optionalData) {
		System.out.println("Send SWIPE message to iphone client.");
		...
		String eventrequest = "INVOKE SWIPE " + classname + " " + address;
	...
	public boolean isSupportedBy(GComponent gComponent) {
		...
		*/
		...
		for (PropertyType property : comp.getGUIProperties()) {
			if (property.getName().equals("SWIPE") &&
